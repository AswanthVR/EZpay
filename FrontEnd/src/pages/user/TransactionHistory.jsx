...
function formatDate(timestamp) {
    ...
    const formattedDate = date.toLocaleString(); // You can customize the format using options if needed
            ...
            <div className= 'p-4 w-full h-full bg-gray-200  rounded-2xl shadow-xl'>
                <div className=' w-full h-full '>
                    ...
                    {transaction.recharge.addon === null ? (
                        ...
                        <p className='text-gray-600'>{formatDate(transaction.recharge.rechargeDate)}</p>
                    </div>
